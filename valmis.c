...
int main(void) {
  ...
  int elemente = elementideArv("Sisestage massiivi täisarvuline elementide arv: \n");
...
int veergudeArv(int elemendid, int reapikkus) {
  int arv, arv2, ridadeArv;
  arv = elemendid / reapikkus;
  arv2 = elemendid % reapikkus;
  if (arv2 == 0) {
    ridadeArv = arv;
  } else {
    ridadeArv = arv + 1;
